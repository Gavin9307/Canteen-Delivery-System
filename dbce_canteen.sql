...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 08, 2023 at 01:14 PM
...
('dbce', 'admin', 'Langer ', 'Pereira', 'langer13@gmail.com', 'M', 'ADM', 4),
('anjibabu', '12344321', 'Anji', 'Babu', 'anjigoudtonta55@gmail.com', 'M', 'STD', 5),
('langer', '12345678', 'langer', 'pereira', 'langer137@gmail.com', 'M', 'STD', 7);
...
(84, 2, 2, 60, '2023-06-08 06:32:05', 'ACPT', '0000-00-00 00:00:00', 'ewcwec0lo-wecwecwecwec'),
(85, 7, 2, 61, '2023-06-08 07:53:16', 'FNSH', '2023-06-08 13:40:50', '12345678901-');
...
('shop1', 'Shop1@vasavi', 'Tea & Snacks', 'Point-1', 'langerpereira137@gmail.com', '7218389307', 'shop2.png', 2),
('shop3', '12121212', 'Main Course', 'Point-3', 'langerpereira137@gmail.com', '7218389307', 'shop4.png', 4),
('shop5', '56565656', 'Juice Corner', 'Point-5', 'langerpereira137@gmail.com', '7218389307', 'shop6.jpg', 6);
...
--
ALTER TABLE `cart`
  MODIFY `ct_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
...
--
ALTER TABLE `order_detail`
  MODIFY `ord_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;

--
-- AUTO_INCREMENT for table `order_header`
--
ALTER TABLE `order_header`
  MODIFY `orh_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
