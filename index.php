...
<head>
    ...
    <title>Welcome | DBCE-CANTEEN | FOODMUNCH </title>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="d-flex text-center text-white position-relative promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-5">
            <h1 class="display-5 fw-normal">Welcome to DBCE-Canteen</h1>
            <p class="lead fw-normal">Food ordering system of DBCE-Canteen</p>
            <span class="xsmall-font text-muted"></span>
        </div>
    </div>
    <div class="container p-5" id="recommended-shop">
        <h2 class="border-bottom pb-2"><i class="bi bi-shop align-top"></i> Canteen Items</h2>
